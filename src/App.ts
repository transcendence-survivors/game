...
const MONSTER_TYPES: MonsterType[] = [
	{
		id: 'goblin',
		color: { r: 1, g: 0.5, b: 0 },
		maxHp: 100, damage: 5, speed: 0.06,
		width: 0.8, height: 1.8, radius: 0.7,
		attackRange: 2.0, attackCooldownMs: 1000,
		spawnWeight: 1.0,
	},
	{
		id: 'wolf',
		color: { r: 0.4, g: 0.5, b: 0.7 },
		maxHp: 60, damage: 8, speed: 0.10,
		width: 0.6, height: 1.0, radius: 0.5,
		attackRange: 1.6, attackCooldownMs: 800,
		spawnWeight: 0.6,
	},
	{
		id: 'orc',
		color: { r: 0.7, g: 0.2, b: 0.2 },
		maxHp: 250, damage: 12, speed: 0.045,
		width: 1.0, height: 2.2, radius: 0.85,
		attackRange: 2.4, attackCooldownMs: 1200,
		spawnWeight: 0.3,
	},
	{
		id: 'demon',
		color: { r: 0.6, g: 0.2, b: 0.8 },
		maxHp: 500, damage: 18, speed: 0.07,
		width: 1.2, height: 2.5, radius: 1.0,
		attackRange: 2.6, attackCooldownMs: 1300,
		spawnWeight: 0.15,
	},
];
...
export class App {
	...
	private _renderTick(): void {
		...
		if (this._spawner) this._hud.updateEnemyCount(this._spawner.count, this._spawner.max);
		...
		if (this._spawner && this._player && this._health) {
			this._spawner.update(dt, now, elapsed, this._player.position, this._health);
		}
	}
}
